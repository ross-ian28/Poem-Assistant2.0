...
export default function ThesaurusTool() {
  ...
  const run = async () => {
    ...
    const res = await fetch("/api/tools", {
      ...
      body: JSON.stringify({ tool: "thesaurus", input }),
    })
  ...
  return (
    <div className="space-y-4">
      <p className="text-stone-400 text-sm">Find synonyms grouped by tone and nuance — perfect for finding the right word.</p>
      <input
