...
export default function PromptTool() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-mauve text-lg font-gothic text-base">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <label className="text-parchment font-gothic text-3xl">
            Number of prompts: <span className="ml-1 relative top-0.5">{count}</span>
          </label>
      ...
      >
        {loading ? "Conjuring..." : `Generate ${count} Prompt${count > 1 ? "s" : ""}`}
      </button>
