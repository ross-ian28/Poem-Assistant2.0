    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-stone-950 text-stone-100">
      <div className="text-center space-y-6 max-w-md px-6">
        ...
        >
          <button
            type="submit"
            className="mt-4 w-full flex items-center justify-center gap-3 bg-white text-stone-900 font-semibold py-3 px-6 rounded-xl hover:bg-stone-100 transition-colors"
          >
